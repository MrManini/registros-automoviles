 ...
 * @author kevin
 */
public class Chart4Amount extends javax.swing.JFrame {
    public Chart4Amount() {
        initComponents();
        generateChart();
        panel4Chart.repaint();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chart4Amount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Chart4Amount().setVisible(true);
            }
        });
    }
